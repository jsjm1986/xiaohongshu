...
const MODULES: Record<string, Record<string, unknown>> = {
  ...
  role_model: {
    ...
    roles: [{
      ...
      utteranceModes: ['direct_question'], replyDisplayRoles: ['信息翻译者'], targetChars: [6, 30],
      ...
      utteranceModes: ['counterexample'], replyDisplayRoles: ['信息翻译者'], targetChars: [6, 32],
      accountable: false, source: { status: 'hypothesis', evidenceIds: [] },
    }, {
      ...
      utteranceModes: ['detail_spotter'], replyDisplayRoles: ['信息翻译者'], targetChars: [4, 26],
      accountable: false, source: { status: 'hypothesis', evidenceIds: [] },
    }, {
      ...
      utteranceModes: ['knowledge_translation', 'service_answer'], replyDisplayRoles: [], targetChars: [8, 40],
      ...
      utteranceModes: ['social_reaction'], replyDisplayRoles: ['信息翻译者'], targetChars: [3, 18],
      accountable: false, source: { status: 'hypothesis', evidenceIds: [] },
    }, {
      // 双号运营要求恰好 2 个可追责公开身份(IP 本人 + 公开助理)。原 fixture 只有
      // 「信息翻译者」一个,且读者角色的 replyDisplayRoles 指向未定义的「发布者」,
      // 正是线上 5/12 项目的违规形态,被 projectBlueprintCompleteness 挡下。
      id: 'assistant', displayRole: '项目助理', relationToHost: '机构公开助理',
      identityCues: ['对接咨询的人'], situationCues: ['接住具体问题'], motives: ['给下一步核验路径'],
      knowledgePosition: '掌握流程与对接方式', speechPatterns: ['直接说下一步怎么做'], lexicalCues: [],
      interactionHooks: ['给核验路径'], permittedContributions: ['说明流程与对接方式'],
      utteranceModes: ['service_answer', 'identity_route'], replyDisplayRoles: [], targetChars: [8, 40],
      accountable: true, source: { status: 'hypothesis', evidenceIds: [] },
    }],
  },
  claim_policy: {
