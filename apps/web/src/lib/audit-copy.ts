...
export const AUDIT_ACTION_COPY: Record<string, AuditCopy> = {
  ...
  'agent-harness.delete': { label: '删除 Agent 独立创作' },
  'agent-harness.restore': { label: '恢复 Agent 独立创作' },
  'agent-harness.complete': { label: '完成 Agent 独立创作', automatic: true },
  'agent-harness.fail': { label: 'Agent 独立创作未完成', automatic: true },
  'agent-harness.review-blocked': { label: 'Agent 候选复核被阻断', automatic: true },
  'agent-harness.review-retry': { label: '重试 Agent 最终复核' },
  'agent-harness.select': { label: '选择 Agent 终稿候选' },
  'agent-harness.approve': { label: '审批 Agent 终稿候选' },
  'agent-harness.purge': { label: '永久删除 Agent 独立创作' },
...
export const AUDIT_ENTITY_COPY: Record<string, string> = {
  ...
  generation_job: '生成任务',
  agent_harness_job: 'Agent 独立创作任务',
  content_package: '内容包',
