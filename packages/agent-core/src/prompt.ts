...
- 机构/作者答复只可压缩或改顺序，不得新增事实、数字、承诺或改变未知状态。读者侧不得替机构回答项目事实。
